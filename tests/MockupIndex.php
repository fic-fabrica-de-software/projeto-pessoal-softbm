<?php
// Bia Fashion Kids - Mockup Replication
// Arquivo PHP com CSS e JavaScript embutidos
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
...
<body>
    ...
    <div class="header-top">
        Aceitamos pagamento via PIX | Compre parcelado à sem juros
    </div>
    ...
    <header>
        <div class="header-container">
            ...
            <nav>
                ...
                <a href="#quantinhos">Quantinhos</a>
                <a href="#frequentes">Frequentes</a>
                <a href="#acessorios">Acessórios</a>
                <a href="#marcas">Marcas</a>
            </nav>
            <div class="search-bar">
                <input type="text" placeholder="Digita aqui você procura">
            </div>
            <div class="header-actions">
                <button title="Minha Conta">👤</button>
                <button class="cart-icon-wrapper" title="Carrinho">
                    🛒
    ...
    <main>
        <div class="container">
            <p style="text-align: center; color: #666666; font-size: 14px;">
                Clique no botão abaixo para ver detalhes do produto
            </p>
        </div>
    </main>
        ...
        <div class="footer-container">
            <div class="footer-grid">
                ...
                <div class="footer-section footer-brand">
                    <div class="footer-logo">Bia</div>
                    <p class="footer-text">Nós celebramos a infância com estilo e conforto.</p>
                    <p style="font-weight: 600; color: #333333; margin-top: 12px;">Venha nos visitar:</p>
                    <p class="footer-text" style="font-size: 12px;">
                        Rua Lemos Azul, 704<br>
                        São Paulo - SP
                    </p>
                    <p class="footer-text" style="font-size: 12px;">
                        contato@biafashionkids.com
                    </p>
                </div>
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        ...
                        <li><a href="#">Letras de Termos</a></li>
            ...
            <div class="footer-bottom">
                © 2024 Bia Fashion Kids. Todos os direitos reservados.
            </div>
        </div>
    </footer>
